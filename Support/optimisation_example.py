...
def optFuncVELA(names, values):
    ...
    try:
        ...
        constraintsListBA1 = {
            ...
            'ip_Sx': {'type': 'lessthan', 'value': 1e6*twiss['sigma_x'][ipindex], 'limit': 100, 'weight': 25},
            'ip_Sy': {'type': 'lessthan', 'value': 1e6*twiss['sigma_y'][ipindex], 'limit': 100, 'weight': 25},
        ...
        if delta < bestdelta:
            ...
            OM.export_yaml(auto=False, filename='optimise_70pC.yaml', directory='.')
        return delta
...
def optimise_Lattice(q=70, do_optimisation=False, quads=None):
