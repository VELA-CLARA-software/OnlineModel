...
def optFuncVELA(names, values):
    ...
    # try:
        ...
        if delta < bestdelta:
            ...
            OM.export_yaml(auto=False, filename=YAMLFILE, directory='.')
...
if __name__ == '__main__':
    global YAMLFILE
    YAMLFILE = './Support/optimise_10pC_Hector.yaml'
    OM.import_yaml(filename=YAMLFILE)
    OM.modify_widget('Linac:tracking_code:value', 'Elegant')
    # OM.modify_widget('generator:charge:value', 10)
