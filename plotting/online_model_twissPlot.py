...
class twissPlotWidget(multiPlotWidget):
    ...
    plotParams = [
                   ...
                   {'label': 'Momentum', 'name': 'cp', 'quantity': 'cp', 'range': [0,50e6], 'units': 'eV/c', 'ymin': 0},
                   'next_row',
                   {'label': 'Momentum Spread', 'name': '&sigma;<sub>cp</sub>', 'quantity': 'sigma_cp', 'range': [0,1e6], 'units': 'eV/c', 'ymin': 0},
