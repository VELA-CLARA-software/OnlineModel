import run_parameters_parse as yaml_parser
...
class DatabaseController():
    ...
    def are_settings_in_db(self, settings_to_save=None):
        if settings_to_save == None:
            ...
            print('Checking dictionary against database...')
    ...
    def get_run_id_for_settings(self, settings_to_save=None):   
        if settings_to_save == None:
            if self.settings_dict != None:
                ...
                return get_run_id_for_settings(settings_to_check)
            else:
                print('Supply a settings dictionary, or load yaml settings before checking database')
        else:
            print('Checking dictionary against database...')
