...
a = Analysis(['.\\mainapp.py'],
        ...
        ('..\\SimFrame\\MasterLattice\\Data_Files\\Sz5um10mm.*', 'MasterLattice\\Data_Files'),
				...
				('.\\data\\CLA10-BA1_OM.def', 'data'),
			],
             hiddenimports=['munch', 'yaml'],
             hookspath=['.\\hooks'],
             runtime_hooks=[],
             excludes=['notebook', 'matplotlib', 'FixTk', 'tcl', 'tk', '_tkinter', 'tkinter', 'Tkinter', 'scipy', 'ruamel', 'ruamel.yaml'],
