...
class Data(object):
    ...
    def get_data(self):
        ...
        self.laser_values.update({'spot_size_x': collections.OrderedDict()})
        self.laser_values['spot_size_x'].update({'type': 'generator'})
        self.laser_values['spot_size_x'].update({'value': self.Framework.generator['sigma_x']})
        self.laser_values.update({'spot_size_y': collections.OrderedDict()})
        self.laser_values['spot_size_y'].update({'type': 'generator'})
        self.laser_values['spot_size_y'].update({'value': self.Framework.generator['sigma_y']})
